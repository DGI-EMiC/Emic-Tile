...
TILE.preLoad=null;
TILE.scale=1;
TILE.savepath = 'http://localhost/Development/';
(function($){
  var tile=this;
  ...
  $.extend(FloatingDiv.prototype, {
    ...
    init: function(myID, labels) {
      ...
      $('img#btnAddLabel').live('click', function() {
        ...
        if (newNum == 5) {
          $('#btnAddLabel').css('visibility','hidden');
        }
				
        // add Autocomplete to the new Element
        $("input#formLabel"+newNum).autocomplete({
          source:self.labelNames
        });
  ...
  var PluginController=function(args){
    ...
    $("body").bind("floatDivOutput",{
      obj:self
    },self._floatDivOutputHandle);
    ...
    $("body").live("colorChanged",function(e,color,link){
      ...
      if(link){
        ...
        $("body:first").trigger("dataUpdated",[{
          "id":obj.id,
          "type":link.type,
          "obj":obj
        }]);
    ...
    setUpToolData:function(){
      ...
      function recLoad(i){
        ...
        if(self.toolSet[toolIds[i]].output){
          $("body").bind(self.toolSet[toolIds[i]].output,{
            obj:self
          },self._toolOutputHandle);
        }
        ...
        if(/http\:|\.[jgpt]*/i.test(obj1.jsonName)){
          ...
          if($.inArray(obj2.id,json.pages[page][obj1.type][found][obj2.type])){
            ...
            robj1={
              ...
              "type":obj1.type,
              "jsonName":page,
              "obj":deepcopy(json.pages[page][obj1.type][found])
            };
          ...
          if($.inArray(obj2.id,json[obj1.type][found][obj2.type])<0){
            ...
            robj1={
              ...
              "type":obj1.type,
              "jsonName":obj1.type,
              "obj":deepcopy(json[obj1.type][found])
            };
          }
        ...
        if(/http\:|\.[jgpt]*/i.test(obj2.jsonName)){
          ...
          if($.inArray(obj2.id,json.pages[page][obj2.type][found][obj1.type])){
            ...
            robj2={
              ...
              "type":obj2.type,
              "jsonName":page,
              "obj":deepcopy(json.pages[page][obj2.type][found])
            };
          }
        } else {
          var found=-1;
          ...
          if($.inArray(obj1.id,json[obj2.type][found][obj1.type])<0){
            ...
            robj2={
              ...
              "type":obj2.type,
              "jsonName":obj2.type,
              "obj":deepcopy(json[obj2.type][found])
            };
          }
        }
        removeLoad();
  ...
  var LoadDialog=function(){
    ...
    this.submitB.live('click',{
      obj:this
    },this.submitFileHandle);
    ...
    $("body").bind("openNewImage",{
      obj:this
    },this.close);
    $("body").bind("openImport",{
      obj:this
    },this.close);
    $("body").bind("openExport",{
      obj:this
    },this.close);
    $("body").bind("openLoadTags",{
      obj:this
    },this.display);
    $("body").bind("closeLoadTags",{
      obj:this
    },this.close);
  };
  ...
  TileToolBar=function(args){
    ...
    self.LoadB.click(function(e){
      ...
      if(!self.loadDialog){
        self.loadDialog=new LoadDialog({
          loc:$("body")
        });
